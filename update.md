# 2026.01.31
- 유저 리뷰 제공의 장르 태그를 제공
- 기존 AI 번역 기능 제거, 기본 구글 번역으로 대체
- 별점 제공과 더불어 평점 데이터를 함께 제공하도록 변경
- 저장된 목록 데이터에 대한 캐시 용량 정보 제공
- 선호/불호 장르 지정 기능의 저장 방식을 매 타이핑 시 저장으로 변경
- 일부 UI 수정

***
# 2026.01.26
- [폴더선택] 기능을 통해 폴더 내 파일명들을 일괄적으로 목록에 추가할 수 있는 기능 추가

***
# 2026.01.21
- [내보내기] 기능을 통해 다운로드 되는 텍스트 파일이 보유 파일 목록을 포함시키도록 변경
- 코드 뒤에 띄어쓰기가 포함되어 있을 경우, 공백 부분까지 하이라이트 처리되는 버그 수정

***
# 2026.01.20
- 파일명 열람 및 수정/추가/제거 기능 추가
...
- 코드 뒤에 .7z 확장자가 오는 경우, 코드를 인식하지 못하던 버그 수정
***
# 2026.01.14

- 평점 탐색 방식 변경 (탐색 속도 개선)
- 코드 뒤에 정수로 시작하는 버전이 존재하는 경우, 코드를 인식하지 못하던 버그 수정
- 저장된 코드 목록 내보내기 기능 추가
- 후원 버튼 삭제
***
# 2025.08.23
